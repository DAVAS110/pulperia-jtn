...
const dailyReport = async (req, res) => {
  try {
    // Soporta date (un día) o date_from + date_to (rango)
    ...
    const [salesRes, salesDetailRes, movRes, treasuryRes, lowStockRes] =
      ...
      `,
        ...
        // Detalle completo de cada venta con fecha y hora en hora local CR
        pool.query(
          `
        SELECT
          s.id,
          TO_CHAR(s.created_at AT TIME ZONE 'America/Costa_Rica', 'YYYY-MM-DD') AS fecha,
