...
import { FiTag, FiEdit, FiTrash2, FiSave } from "react-icons/fi";
  ...
  return (
    <>
      <div className="page-header">
        <div>
          <h1>Categorías</h1>
          <p>{cats.length} categorías registradas</p>
        </div>
        {isAdmin() && (
            ...
            >
              ...
              {isAdmin() && (
                <div style={{ display: "flex", gap: 6 }}>
                  ...
                  <button className="btn-icon" onClick={() => setConfirm(c.id)}>
                    <FiTrash2 />
                  </button>
                </div>
              )}
      ...
      <ConfirmDialog
        ...
        message="¿Eliminar esta categoría? Los productos no serán eliminados."
        danger
      />
    </>
  );
