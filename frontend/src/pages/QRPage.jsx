...
import { FiSearch, FiPrinter, FiCamera, FiBox } from "react-icons/fi";
...
export default function QRPage() {
  ...
  useEffect(() => {
    productsAPI
      ...
      .then(({ data }) => {
        ...
        if (data.products[0]) setSelected(data.products[0]);
      })
  ...
  const handleSkuSearch = async (e) => {
    ...
    try {
      ...
      setScanResult("Producto no encontrado");
  ...
  return (
    <>
      <div className="page-header">
        <div>
          <h1>Códigos QR</h1>
          <p>Genera e imprime QR por producto</p>
        </div>
      </div>
      <div
        style={{
            ...
            {filtered.map((p) => (
              <div
                ...
                style={{
                  ...
                  cursor: "pointer",
                  background:
                    selected?.id === p.id ? "var(--accent-light)" : "white",
                  borderBottom: "1px solid var(--border)",
        ...
        <div style={{ display: "flex", flexDirection: "column", gap: 16 }}>
          {selected && (
            <div className="card card-body" style={{ textAlign: "center" }}>
              ...
              >
                {selected.sku} · Stock: {selected.stock}
              </div>
              <div
                style={{
                  display: "flex",
          ...
          <div className="card card-body">
            ...
            <div className="search-input">
              ...
              <input
                placeholder="Escribe o escanea un SKU y presiona Enter…"
