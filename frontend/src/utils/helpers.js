export const fmt = (n) =>
  '₡' + Number(n || 0).toLocaleString('es-CR', { minimumFractionDigits: 0, maximumFractionDigits: 2 });
...
export const MOVEMENT_LABELS = { entrada: 'Entrada', salida: 'Salida', ajuste: 'Ajuste', pérdida: 'Pérdida', venta: 'Venta' };
export const MOVEMENT_COLORS = { entrada: '#2d7a4f', salida: '#c0392b', ajuste: '#1a5fa8', pérdida: '#b45309', venta: '#9b59b6' };
